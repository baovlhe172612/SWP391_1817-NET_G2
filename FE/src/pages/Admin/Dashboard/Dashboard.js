...
//     return `${year}-${month}`; // or use a more readable format like `${new Date(yearMonth).toLocaleString('default', { month: 'long' })} ${year}`;
//   };
...
//   //   return "hsl(330, 70%, 70%)"; // Light pink color
//   // };
//   // const getRandomColor = () => {
//   //   return "hsl(500, 100%, 50%)"; // Yellow color
//   // };
...
//             <Link to="/admin/MostSoldProducts"><DoubleRightOutlined />Xem biểu đồ sản phẩm bán chạy nhất<DoubleRightOutlined /></Link>
//           </div>
