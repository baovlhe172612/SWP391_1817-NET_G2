    ...
    <div className="container">
      <div className="signin-content">
        <div className="signin-form">
          ...
          <Form name="login" onFinish={onFinish} className="register-form" id="login-form">
            <Form.Item
              name="username"
              rules={[
                {
            ...
            >
              <Input prefix={<UserOutlined />} placeholder="Your Name (case-sensitive)" />
            </Form.Item>
            ...
            >
              <Input.Password prefix={<LockOutlined />} placeholder="Password (case-sensitive)" />
            </Form.Item>
