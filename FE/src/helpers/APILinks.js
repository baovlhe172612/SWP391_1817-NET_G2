...
export const BLOG_COMMITTING = `${LOCALHOST_API}/api/POST/committing`;
export const DELETE_BLOG_ID = `${LOCALHOST_API}/api/POST/delete`;

export const UPDATE_BLOG = `${LOCALHOST_API}/api/POST/update_post`;
export const SEARCH_BLOG = `${LOCALHOST_API}/api/POST/search`;
// API STORE
